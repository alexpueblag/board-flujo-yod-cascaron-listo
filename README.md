# Cascaron · board-flujo-yod

Este repo **no tiene codigo**. Es una direccion vieja que sigue viva.

El tablero real vive en `yodesarrollomx/board-flujo-yod` y se sirve en:
...
`https://alexpueblag.github.io/board-flujo-yod/` daria 404 para siempre.
